...
analysis_name <- "validation_analysis_5_subject_10_sample"
...
data_token <- "validation_analysis_4_subject_8_sample"
...
moderate_viral_load_samples <- sort(rownames(sample_metadata_for_SPEEDI_df[sample_metadata_for_SPEEDI_df$viral_load == "moderate",]))
