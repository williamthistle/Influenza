...
ggsave(filename = paste0("C:/Users/willi/Desktop/", "cytokine_deg_heatmap_vaccinated_hvl_bulk.png"), plot = cytokine_heatmap_plot, device='png', dpi=300, width = 5, height = 8, units = "in")
...
ggsave(filename = paste0("C:/Users/willi/Desktop/", "cytokine_deg_heatmap_vaccinated_hvl_bulk_flipped.png"), plot = cytokine_heatmap_plot, device='png', dpi=300, width = 15, height = 3, units = "in")
