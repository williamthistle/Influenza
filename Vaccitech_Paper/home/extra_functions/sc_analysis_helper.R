...
evaluate_scATAC_cell_type_proportion_changes <- function(cell_type_prop_table) {
  ...
  # Unfortunately, we can't use loops because of the way the function call works (I think)
  cell_type_proportion_p_values <- c()
  cell_type_proportion_p_values <- c(cell_type_proportion_p_values, coin::pvalue(coin::wilcox_test(CD16.Mono ~ Condition, data = cell_type_prop_table)))
  cell_type_proportion_p_values <- c(cell_type_proportion_p_values, coin::pvalue(coin::wilcox_test(CD8.Naive ~ Condition, data = cell_type_prop_table)))
  cell_type_proportion_p_values <- c(cell_type_proportion_p_values, coin::pvalue(coin::wilcox_test(CD14.Mono ~ Condition, data = cell_type_prop_table)))
  cell_type_proportion_p_values <- c(cell_type_proportion_p_values, coin::pvalue(coin::wilcox_test(CD4.Naive ~ Condition, data = cell_type_prop_table)))
  cell_type_proportion_p_values <- c(cell_type_proportion_p_values, coin::pvalue(coin::wilcox_test(CD4.Memory ~ Condition, data = cell_type_prop_table)))
  cell_type_proportion_p_values <- c(cell_type_proportion_p_values, coin::pvalue(coin::wilcox_test(B ~ Condition, data = cell_type_prop_table)))
