...
bulk_data_dir <- paste0(onedrive_dir, "Influenza Analysis/Analyses/Bulk_RNA-Seq/Data/")
metadata_dir <- paste0(onedrive_dir, "Influenza Analysis/Analyses/Overall_Metadata/")
...
sc_deg_combined_cell_types_dir <- paste0(onedrive_dir, "Influenza Analysis/Analyses/scRNA-Seq/Results/HVL/DEGs_with_ATAC_cell_types/")
sc_magical_dir <- paste0(onedrive_dir, "Influenza Analysis/Analyses/MAGICAL/Results/HVL/")
sc_humanbase_dir <- paste0(onedrive_dir, "Influenza Analysis/Analyses/scRNA-Seq/Results/HVL/HumanBase/")
