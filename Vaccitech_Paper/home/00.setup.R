...
sc_pseudobulk_genes <- unique(sc_pseudobulk_gene_table$gene)
...
# Should be interesting to compare performance in pseudobulk vs actual bulk for the same subjects
# Should I add LVL subjects back?
sc_aliquots <- c("91910a04711aa3dd", "3731a6247ae23831", "2232300b0e3a3d06", "76ea83ff9293871a", "5fdfdbaeb3c8eee8", "981520e7e138d460", "e3e01c75894ef461", "4534496c580cb408") # 8 samples - 4 paired (HVL)
