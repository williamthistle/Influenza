...
testing_marker <- read.table(paste0(sc_das_dir, "diff_peaks/D28-vs-D_minus_1-degs-CD14_Mono-time_point-controlling_for_subject_id_sc_filtered_pct_0.01.tsv"), sep = "\t", header = TRUE)
...
hist(testing_marker$avg_log2FC, 100, col = "gray", main = "",
...
testing_marker_negative_seqs <- getSeq(BSgenome.Hsapiens.UCSC.hg38, testing_marker_negative)
testing_marker_positive_seqs <- getSeq(BSgenome.Hsapiens.UCSC.hg38, testing_marker_positive)
