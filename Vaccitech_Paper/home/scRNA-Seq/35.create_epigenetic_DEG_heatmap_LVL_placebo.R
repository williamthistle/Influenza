...
# Final heatmap genes
heatmap_genes <- c("KDM6B")

heatmap_gene_types <- list()
heatmap_gene_types[["KDM6B"]] <- "Lysine Demethylase"

##### TOO FEW GENES TO MAKE A HEATMAP #####
...
ggsave(filename = paste0("C:/Users/willi/Desktop/", "epigenetic_remodeling_deg_lvl_placebo_heatmap.png"), plot = epigenetic_remodeling_heatmap_plot, device='png', dpi=300, width = 5, height = 5, units = "in")
...
ggsave(filename = paste0("C:/Users/willi/Desktop/", "epigenetic_remodeling_deg_heatmap_lvl_placebo_flipped.png"), plot = epigenetic_remodeling_heatmap_plot, device='png', dpi=300, width = 8, height = 3, units = "in")
