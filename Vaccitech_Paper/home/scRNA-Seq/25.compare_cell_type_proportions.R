...
lvl_placebo_cell_type_props_unfiltered_results <- evaluate_scRNA_cell_type_proportion_changes(hvl_placebo_cell_type_props_unfiltered)
lvl_placebo_cell_type_props_results <- evaluate_scRNA_cell_type_proportion_changes(hvl_placebo_cell_type_props)